...
public enum VdcBllMessages {
    ...
    VAR__ACTION__REBALANCE_STATUS,
    VAR__ACTION__REPLACE,
    VAR__ACTION__REBALANCE_OPERATION,
    VAR__ACTION__MERGE,
    VAR__ACTION__PAUSE,
    ...
    NETWORK_NETWORK_EXISTS_IN_ADD_AND_REMOVE,
    NETWORK_NETWORK_HAVE_NO_INERFACES,
