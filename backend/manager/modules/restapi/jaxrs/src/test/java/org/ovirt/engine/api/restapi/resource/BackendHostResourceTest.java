...
//    }
    ...
    protected void verifyQuery(AbstractStatisticalQuery<Host, VDS> query, VDS entity) throws Exception {
        ...
        verifyStatistics(statistics,
                         new String[] {"memory.total", "memory.used", "memory.free",
                         ...
                         new BigDecimal[] {asDec(5120*Mb), asDec(1024*Mb), asDec(35*Mb), asDec(0), asDec(0), asDec(30*Mb),
                                           asDec(25*Mb), asDec(5*Mb), asDec(0), asDec(40), asDec(45), asDec(50), asDec(55), new BigDecimal(0.0060, new MathContext(2))});
