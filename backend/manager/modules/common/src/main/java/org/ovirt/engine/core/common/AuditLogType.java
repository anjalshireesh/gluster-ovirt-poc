...
public enum AuditLogType {
    ...
    GLUSTER_VOLUME_START(3004),
    GLUSTER_VOLUME_START_FAILED(3005),
    GLUSTER_VOLUME_STOP(3006),
    GLUSTER_VOLUME_STOP_FAILED(3007),
    GLUSTER_VOLUME_ADD_BRICK(3008),
    GLUSTER_VOLUME_ADD_BRICK_FAILED(3009),
    GLUSTER_VOLUME_REMOVE_BRICK(3010),
    GLUSTER_VOLUME_REMOVE_BRICK_FAILED(3011),
    GLUSTER_VOLUME_OPTION_SET(3012),
    GLUSTER_VOLUME_OPTION_SET_FAILED(3013),
    GLUSTER_VOLUME_REPLACE_BRICK_START(3014),
    GLUSTER_VOLUME_REPLACE_BRICK_START_FAILED(3015),
    GLUSTER_VOLUME_REPLACE_BRICK_ABORT(3016),
    GLUSTER_VOLUME_REPLACE_BRICK_ABORT_FAILED(3017),
    GLUSTER_VOLUME_REPLACE_BRICK_PAUSE(3018),
    GLUSTER_VOLUME_REPLACE_BRICK_PAUSE_FAILED(3019),
    GLUSTER_VOLUME_REPLACE_BRICK_COMMIT(3020),
    GLUSTER_VOLUME_REPLACE_BRICK_COMMIT_FAILED(3021),
    GLUSTER_VOLUME_REBALANCE_START(3022),
    GLUSTER_VOLUME_REBALANCE_START_FAILED(3023),
    GLUSTER_VOLUME_REBALANCE_STOP(3024),
    GLUSTER_VOLUME_REBALANCE_STOP_FAILED(3025),
    GLUSTER_VOLUME_REBALANCE_STATUS(3026),
    GLUSTER_VOLUME_REBALANCE_STATUS_FAILED(3027),
