...
public enum AuditLogType {
    ...
    GLUSTER_VOLUME_START(3002),
    GLUSTER_VOLUME_START_FAILED(3003),
    GLUSTER_VOLUME_STOP(3004),
    GLUSTER_VOLUME_STOP_FAILED(3005),
    GLUSTER_VOLUME_ADD_BRICK(3006),
    GLUSTER_VOLUME_ADD_BRICK_FAILED(3007),
    GLUSTER_VOLUME_REMOVE_BRICK(3008),
    GLUSTER_VOLUME_REMOVE_BRICK_FAILED(3009),
    GLUSTER_VOLUME_DELETE(3010),
    GLUSTER_VOLUME_DELETE_FAILED(3011),
