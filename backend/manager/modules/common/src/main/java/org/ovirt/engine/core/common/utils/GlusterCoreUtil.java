...
//	}
	...
	/**
	 * Compares the two GlusterEntity lists and returns the list of entities from first list that have been modified in the second
	 * 
	 * @param oldEntities
	 * @param newEntities
	 ...
	 * @param oldEntities
	 * @param newEntities
	 * @param caseInsensitive If true, the GlusterEntity name comparison will be done in case insensitive manner
	...
	public static <T extends GlusterEntity> T getEntity(Collection<T> entityList, String searchEntityName, boolean caseInsensitive) {
