...
Create or replace FUNCTION UpdateGlusterVolumeBrick(v_volume_id UUID, v_host_id UUID, v_brick_dir VARCHAR(4096), 
                           v_new_host_id UUID, v_new_brick_dir VARCHAR(4096), v_new_status INTEGER)
RETURNS VOID
   AS $procedure$
BEGIN
