...
Create or replace FUNCTION InsertAuditLog(INOUT v_audit_log_id INTEGER ,  
 ...
 v_vm_template_id UUID ,  
    ...
    v_gluster_volume_name VARCHAR(255))
   AS $procedure$
   DECLARE
...
INSERT INTO audit_log(LOG_TIME, log_type, log_type_name, severity,message, user_id, USER_NAME, vds_id, VDS_NAME, vm_id, VM_NAME,vm_template_id,VM_TEMPLATE_NAME,storage_pool_id,STORAGE_POOL_NAME,storage_domain_id,STORAGE_DOMAIN_NAME,vds_group_id,vds_group_name,gluster_volume_id,gluster_volume_name)
		VALUES(v_log_time, v_log_type, v_log_type_name, v_severity, v_message, v_user_id, v_user_name, v_vds_id, v_vds_name, v_vm_id, v_vm_name,v_vm_template_id,v_vm_template_name,v_storage_pool_id,v_storage_pool_name,v_storage_domain_id,v_storage_domain_name,v_vds_group_id,v_vds_group_name,v_gluster_volume_id,v_gluster_volume_name);
...
BEGIN
      ...
      vds_group_id = v_vds_group_id,vds_group_name = v_vds_group_name, gluster_volume_id=v_gluster_volume_id, gluster_volume_name=v_gluster_volume_name
