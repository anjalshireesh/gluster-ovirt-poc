...
public class PoolListModel extends ListWithDetailsModel
{
    ...
    public void New()
    {
        ...
        model.getDataCenter().setSelectedItem(Linq.FirstOrDefault(Linq.<storage_pool> Cast(model.getDataCenter()
                .getItems())));
        ...
        if (vm != null)
        {
            ...
            if (model.getDataCenter().getSelectedItem() == null)
            {
                java.util.ArrayList<storage_pool> list =
                        new java.util.ArrayList<storage_pool>(java.util.Arrays.asList(new storage_pool[] { DataProvider.GetDataCenterById(vm.getstorage_pool_id()) }));
    ...
    public void OnSave()
    {
        ...
        AddVmPoolWithVmsParameters tempVar2 =
                new AddVmPoolWithVmsParameters(pool,
                        desktop,
                        model.getIsAddVMMode() ? Integer.parseInt(model.getNumOfDesktops().getEntity().toString()) : 0,
                        0);
